...
const OrbitingCirclesDemo = () =>  {
  return (
    <div className="relative flex h-screen w-full max-w-full items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
...
export {Marquee3D,OrbitingCirclesDemo,MarqueeDemo,BoxRevealDemo};
